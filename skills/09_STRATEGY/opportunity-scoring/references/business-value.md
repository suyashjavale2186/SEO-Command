...
**Purpose.** This reference gives the `opportunity scoring` skill a concrete operating method for **business value scoring**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Estimate the economic importance of an opportunity using margin, lead quality, strategic fit, retention, market entry, or other business outcomes. [Evidence Tier: Tier 4 — Hypothesis]
...
Use observed business data when possible and label assumptions explicitly. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
