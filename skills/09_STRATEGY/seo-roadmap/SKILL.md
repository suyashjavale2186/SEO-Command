---
name: seo-roadmap
description: Create a sequenced SEO roadmap that connects business goals, site/search opportunities, dependencies, experiments, and measurement into an adaptive operating plan.
---
...
2. Prioritize through the governance evidence gate and prioritization score.
3. Map dependencies, prerequisites, owners, validation, and learning loops.
4. Separate committed work from contingent work that depends on future evidence.
5. Build the roadmap as a feedback system, not a static content calendar.
...
Return: strategic objective; current state; opportunity portfolio; sequence; dependencies; measurement; experiments; decision gates; recommendation blocks.
