---
name: prioritization
description: Order approved SEO actions using expected business impact, probability of success, evidence confidence, and effort, including an explicit IGNORE bucket.
---

# Prioritization

## Purpose
Order approved SEO actions using expected business impact, probability of success, evidence confidence, and effort, including an explicit IGNORE bucket.

## When to trigger this skill
When a backlog contains more approved actions than available capacity or when deciding the next best SEO moves.

## Step-by-step workflow
1. Collect recommendations and normalize their impact, success probability, evidence confidence, and effort.
2. Apply the defined Priority formula: Expected Business Impact × Probability of Success × Evidence Confidence ÷ Effort.
3. Assign NOW, NEXT, LATER, or IGNORE.
4. Use IGNORE for ideas that sound clever but are unlikely to materially help or carry disproportionate risk.
5. Re-run prioritization when new evidence changes business value, feasibility, or confidence.
...
Return: prioritized backlog; score rationale; NOW/NEXT/LATER/IGNORE buckets; recommendation blocks.
