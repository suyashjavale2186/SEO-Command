---
name: content-brief
description: Produce an opportunity-driven, writer-ready brief grounded in the live SERP, audience need, business objective, information advantage, and available first-party evidence.
---

# Content Brief

## Purpose
Produce an opportunity-driven, writer-ready brief grounded in the live SERP, audience need, business objective, information advantage, and available first-party evidence.

## When to trigger this skill
When creating a new page/article or replacing an outdated brief for an existing topic.

## Step-by-step workflow
1. Establish business goal, audience, target query/topic, and intended conversion.
2. Inspect the live SERP and classify intent; compare representative leading results for what users are being offered.
3. Map must-cover information, differentiating evidence, missing perspectives, and first-party knowledge opportunities.
4. Choose the appropriate content type and information architecture from the evidence; never select format because of a fixed word-count formula.
5. Define a clear information-advantage objective and fact-checking plan.
6. Pass the brief through evidence-engine and red-team before finalization.
...
Return: brief objective; audience; search intent; SERP observations; structure; information requirements; first-party evidence plan; conversion path; recommendation blocks.
