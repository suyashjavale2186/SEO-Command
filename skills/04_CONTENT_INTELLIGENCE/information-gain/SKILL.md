...
description: Find and score the information that can make a page more useful and defensibly differentiated from competing results, emphasizing original evidence over superficial novelty.
---

# Information Gain

## Purpose
Find and score the information that can make a page more useful and defensibly differentiated from competing results, emphasizing original evidence over superficial novelty.

## When to trigger this skill
When comparing a draft/page with competitors, approving a brief, or deciding whether content contains enough unique value to publish.

## Step-by-step workflow
1. Collect competitor topics/entities/claims and identify what is common versus distinctive.
2. Identify first-party evidence: original data, test results, real examples, expert experience, methodology, constraints, and honest failures.
3. Map missing or weakly supported information into an information-advantage matrix.
4. Calculate an Information Advantage Score using the reference rubric; treat it as an internal decision aid, not a Google score.
5. Set a publish gate based on evidence and usefulness, not a mandatory numeric threshold; if differentiation is weak, recommend more research or first-party input.
...
Return: common baseline; differentiated evidence; missing information; Information Advantage Score with rubric; publish decision; recommendation blocks.
