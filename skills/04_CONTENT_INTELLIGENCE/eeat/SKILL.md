---
name: eeat
description: Audit visible evidence of Experience, Expertise, Authority, and Trustworthiness and recommend concrete improvements without inventing credentials or experience.
---

# Eeat

## Purpose
Audit visible evidence of Experience, Expertise, Authority, and Trustworthiness and recommend concrete improvements without inventing credentials or experience.

## When to trigger this skill
When auditing content quality, author context, YMYL-sensitive pages, product reviews, service pages, case studies, or thought leadership.

## Step-by-step workflow
1. Assess Experience: is first-hand work actually demonstrated and verifiable?
2. Assess Expertise: are explanations accurate, nuanced, and supported by competent authorship or sources?
3. Assess Authority: does the site/person have relevant recognition, citations, relationships, or demonstrated standing?
4. Assess Trust: are claims, authorship, methodology, incentives, limitations, and contact/ownership signals sufficiently transparent?
5. Separate missing evidence from negative evidence.
6. Recommend evidence-building actions only when the business can truthfully support them.
...
Return: Experience/Expertise/Authority/Trust findings; evidence gaps; verification needs; prioritized recommendation blocks.
...
Never manufacture first-person experience, credentials, customer stories, test results, or endorsements.
