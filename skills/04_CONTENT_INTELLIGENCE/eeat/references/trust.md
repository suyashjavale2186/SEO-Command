...
- # YMYL Scoring Rubric [Evidence Tier: Tier 3 — Industry observation]


- Elevated E-E-A-T standards for Your Money or Your Life content. Use this rubric instead of the main 40-point rubric when the topic can affect a reader's health, finances, safety, legal standing, or civic participation. [Evidence Tier: Tier 3 — Industry observation]


- ## Google's YMYL definition [Evidence Tier: Tier 3 — Industry observation]


- Google's Search Quality Rater Guidelines define YMYL as topics that "could significantly impact the health, financial stability, or safety of people, or the welfare or well-being of society." The guidelines break this into three harm categories: [Evidence Tier: Tier 3 — Industry observation]


- - **YMYL Health or Safety.** Mental, physical, or emotional health, or any form of safety. [Evidence Tier: Tier 3 — Industry observation]


- - **YMYL Financial Security.** Anything that could damage a person's ability to support themselves or their family. [Evidence Tier: Tier 3 — Industry observation]


- - **YMYL Government, Civics & Society.** Public institutions, election and voting information, anything that shapes how groups of people are treated. [Evidence Tier: Tier 3 — Industry observation]


- If a topic fits any of those three, the rater is instructed to apply stricter E-E-A-T standards. This rubric encodes what "stricter" means in practice. [Evidence Tier: Tier 3 — Industry observation]


- ## What makes a topic YMYL [Evidence Tier: Tier 3 — Industry observation]


- - **Medical.** Health conditions, symptoms, medications, dosages, treatments, drug interactions, pregnancy, mental health, nutrition for a specific condition. [Evidence Tier: Tier 3 — Industry observation]


- - **Parenting.** Infant care, vaccination, developmental milestones, discipline methods. [Evidence Tier: Tier 3 — Industry observation]


## Elite adaptation


The retained pattern should be applied to the real user and business context: Make ownership, authorship, sourcing, disclosures, limitations, corrections, contact routes, and commercial incentives clear where relevant. The reference is a decision aid, not a ranking formula. Start with the observed situation, classify the underlying task or risk, select an intervention that directly addresses it, and define how the result will be validated. [Evidence Tier: Tier 4 — Hypothesis]
...
Suppose Trust work should focus on reducing uncertainty and making claims auditable. Begin by proving the symptom exists and identifying the page/query/business role involved. If the evidence points to a content problem, add useful information or fix the intent mismatch; if it points to technical access or indexation, fix the underlying technical state first. Do not use a content rewrite to treat a problem whose evidence points elsewhere. [Evidence Tier: Tier 2 — Strong empirical evidence]
