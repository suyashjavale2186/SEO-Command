---
name: write-content
description: Produce evidence-first content that satisfies search intent, demonstrates real thinking and expertise, uses first-party inputs when available, and avoids generic AI-generated filler.
---

# Write Content

## Purpose
Produce evidence-first content that satisfies search intent, demonstrates real thinking and expertise, uses first-party inputs when available, and avoids generic AI-generated filler.

## When to trigger this skill
When a brief, topic, existing page, or expert knowledge document is ready for drafting.

## Step-by-step workflow
1. Load the approved brief, audience model, business goal, evidence ledger, expert input, and information-advantage requirements.
2. Research current facts and SERP context where needed; cite sources and distinguish sourced facts from expert opinion.
3. Draft around user needs and the chosen content structure. Cover necessary concepts naturally without density targets or padding.
4. Inject authentic first-party details only when supplied and attributable. If first-hand evidence is unavailable, do not manufacture first-person experience or fabricated expertise.
5. Run the anti-slop pass for originality, specificity, useful opinions, evidence, limitations, and natural voice—not for AI-detector evasion.
6. Run fact-checking, structured-data eligibility checks, and red-team review before delivery.
...
Return: publication-ready draft; source/evidence notes; first-party attribution notes; fact-check findings; structural QA; recommendation blocks.
...
Do not optimize for “sounding human” as a disguise. Optimize for useful, evidence-backed, original work.
