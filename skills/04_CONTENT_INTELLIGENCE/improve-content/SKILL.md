...
description: Improve existing content using observed performance, SERP changes, decay signals, user needs, and evidence gaps rather than generic rewrites.
---

# Improve Content

## Purpose
Improve existing content using observed performance, SERP changes, decay signals, user needs, and evidence gaps rather than generic rewrites.

## When to trigger this skill
When a page has declining or mismatched performance, stale information, weak conversion, intent mismatch, or a clear content-quality gap.

## Step-by-step workflow
1. Establish baseline from Search Console, analytics, page content, links, SERP observations, and business outcome data where available.
2. Diagnose whether the issue is search intent, content quality, evidence/originality, freshness, conversion path, internal linking, or technical accessibility.
3. Choose the least destructive change set that addresses the observed issue.
4. Preserve successful evidence and first-party voice while removing outdated, weak, redundant, or unsupported claims.
5. Fact-check and red-team the revised page before publishing.
6. Define post-update measurement and learning log.
...
Return: baseline; diagnosis; changes; evidence; before/after rationale; validation metrics; recommendation blocks.
