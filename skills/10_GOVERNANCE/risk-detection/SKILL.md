---
name: risk-detection
description: Identify SEO implementation, policy, factual, technical, reputational, attribution, and opportunity-cost risks before work is approved.
---

# Risk Detection

## Purpose
Identify SEO implementation, policy, factual, technical, reputational, attribution, and opportunity-cost risks before work is approved.

## When to trigger this skill
Whenever a recommendation could have broad site impact, policy implications, reputational consequences, or meaningful opportunity cost.

## Step-by-step workflow
1. Classify risks by type and severity.
2. Check Google Search spam-policy implications for manipulative tactics.
3. Check technical regression, indexation, UX, attribution, and maintenance risks.
4. Identify mitigation, rollback, and owner requirements.
5. Pass material risks to red-team and prioritization.
...
Return: risk register; evidence; severity; mitigation; rollback; residual risk; recommendation blocks.
