...
**Purpose.** This reference gives the `risk detection` skill a concrete operating method for **scaled content risk**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Screen programmatic and AI-assisted production for low-value repetition, thin variations, fabricated evidence, and pages created primarily to manipulate search visibility. [Evidence Tier: Tier 4 — Hypothesis]
