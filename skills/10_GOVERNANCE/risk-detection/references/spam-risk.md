...
**Purpose.** This reference gives the `risk detection` skill a concrete operating method for **spam risk**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Evaluate whether tactics manipulate rankings, scale low-value pages, mislead users, or create artificial link signals. [Evidence Tier: Tier 4 — Hypothesis]
...
Google's spam policies cover attempts to manipulate Search systems, including manipulation of generative AI responses. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
