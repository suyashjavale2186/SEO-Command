---
name: red-team
description: Stress-test an SEO strategy, audit, brief, or content plan before execution by challenging assumptions, evidence quality, business alignment, user experience, and policy risk.
---

# Red Team

## Purpose
Stress-test an SEO strategy, audit, brief, or content plan before execution by challenging assumptions, evidence quality, business alignment, user experience, and policy risk.

## When to trigger this skill
Before finalizing a material strategy, content plan, technical roadmap, link campaign, or recommendation set.

## Step-by-step workflow
1. Restate the proposed strategy and the intended business outcome.
2. List the key assumptions and identify which are observed facts, evidence-backed inferences, or hypotheses.
3. Challenge competitor comparability, causality, data completeness, search-intent interpretation, and implementation feasibility.
4. Check for traffic-over-revenue optimization, copied competitor structures without added value, fabricated expertise, scaled low-value content risk, and manipulative link tactics.
5. Check technical and user-experience side effects, including indexation, accessibility, misleading claims, intrusive elements, and maintenance burden.
6. For each challenge that survives scrutiny, create a recommendation with the exact evidence status block. For rejected ideas, place them in IGNORE with the reason.
...
Return: Strategy under review; Assumptions; Red-team challenges; Surviving risks; Required changes; Rejected ideas; Final recommendation blocks.
...
A red-team finding is not automatically true; it is a challenge that must itself be evidence-graded.
