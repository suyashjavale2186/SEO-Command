...
**Purpose.** This reference gives the `red team` skill a concrete operating method for **strategy challenge**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Ask whether the strategy solves a real user problem, whether the target is realistically winnable, whether business value is demonstrated, and whether a simpler intervention could do more. [Evidence Tier: Tier 3 — Industry observation]
...
A good red-team review should be able to recommend cancellation when the evidence is weak. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
