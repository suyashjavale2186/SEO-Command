...
**Purpose.** This reference gives the `red team` skill a concrete operating method for **causal inference check**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Look for confounders, concurrent changes, seasonality, SERP shifts, tracking changes, and regression to the mean before attributing outcomes to SEO work. [Evidence Tier: Tier 3 — Industry observation]
