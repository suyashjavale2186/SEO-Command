---
name: seo-myth-detection
description: Detect confident SEO folklore and unsupported rules, especially claims about ranking mechanics or arbitrary optimization thresholds.
---

# Seo Myth Detection

## Purpose
Detect confident SEO folklore and unsupported rules, especially claims about ranking mechanics or arbitrary optimization thresholds.

## When to trigger this skill
Whenever an SEO recommendation cites an alleged Google rule, internal ranking mechanism, hard threshold, or popular tactic with weak evidence.

## Step-by-step workflow
1. Extract the asserted rule.
2. Search for current primary documentation or strong evidence.
3. Determine whether the claim is documented, empirical, observational, or hypothetical.
4. Rewrite unsupported rules as conditional heuristics or hypotheses.
5. Block the claim from being presented as guaranteed ranking behavior.
...
Return: claim; evidence audit; tier; corrected statement; implications; recommendation blocks.
