...
1. Extract material claims and classify them by type and risk.
2. Locate the best available primary or authoritative evidence.
3. Compare the source claim with the proposed wording and scope.
4. Downgrade, qualify, remove, or flag any claim the source does not support.
5. Record unresolved claims for human review.
...
Return: claim ledger; verified claims; unsupported/qualified claims; source notes; recommendation blocks.
