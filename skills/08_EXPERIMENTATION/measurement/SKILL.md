---
name: measurement
description: Define robust measurement for SEO experiments and improvements, including baselines, success metrics, confounders, and confidence interpretation.
---

# Measurement

## Purpose
Define robust measurement for SEO experiments and improvements, including baselines, success metrics, confounders, and confidence interpretation.

## When to trigger this skill
When setting up or evaluating an SEO experiment, rollout, content update, or technical change.

## Step-by-step workflow
1. Select metrics directly connected to the hypothesis.
2. Choose a baseline period or comparator appropriate to the page/query and data availability.
3. Document known confounders and concurrent releases.
4. Assess practical effect size and confidence without pretending observational SEO data provides randomized certainty.
5. Decide whether evidence supports action, further testing, or no conclusion.
...
Return: measurement plan; baseline; metrics; confounders; result interpretation; recommendation blocks.
