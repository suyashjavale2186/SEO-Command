---
name: seo-experiment
description: Run structured SEO experiments and maintain a durable record so the site learns from changes rather than repeating unverified tactics.
---

# Seo Experiment

## Purpose
Run structured SEO experiments and maintain a durable record so the site learns from changes rather than repeating unverified tactics.

## When to trigger this skill
When testing title changes, content evidence, internal-link restructuring, page consolidation, or another measurable SEO intervention.

## Step-by-step workflow
1. Define the hypothesis and baseline.
2. Specify the exact change and pages/queries affected.
3. Log date, expected result, confounders, and measurement method before launch.
4. Collect post-change results while accounting for seasonality, algorithm updates, demand changes, and concurrent modifications.
5. Assess evidence strength and decide whether to adopt, revert, iterate, or remain inconclusive.
6. Write the learning into the site-specific playbook without generalizing beyond the tested context.
...
Return the experiment record with exactly: Hypothesis; Change; Date; Baseline; Expected result; Actual result; Confidence; Decision; Evidence status; recommendation blocks.
