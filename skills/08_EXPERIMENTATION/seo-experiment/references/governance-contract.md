...
**Purpose.** This reference gives the `seo experiment` skill a concrete operating method for **governance contract**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]
