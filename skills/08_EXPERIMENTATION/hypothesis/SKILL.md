---
name: hypothesis
description: Turn SEO observations into testable hypotheses that distinguish what is known from what is being proposed.
---

# Hypothesis

## Purpose
Turn SEO observations into testable hypotheses that distinguish what is known from what is being proposed.

## When to trigger this skill
When an SEO change is intended to learn causally from an outcome or when evidence is mixed.

## Step-by-step workflow
1. State the observed baseline.
2. Write the causal hypothesis in plain language and list assumptions.
3. Define the change, target population/pages, expected direction, alternative explanations, and success metrics.
4. Decide whether a true experiment is feasible or whether the work is an observational before/after test.
5. Pass the hypothesis to seo-experiment and red-team.
...
Return: observation; hypothesis; mechanism as hypothesis; test design; metrics; confounders; recommendation blocks.
