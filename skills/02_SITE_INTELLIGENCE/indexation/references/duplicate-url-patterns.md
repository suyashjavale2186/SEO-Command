...
The fix should match the cause: consolidate genuine duplicates, control crawl paths, or provide distinct localized content where user intent differs. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
