...
Differentiate when the audiences, intents, or evidence are genuinely distinct; merge when overlap is substantial and one canonical destination can serve the need better. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
