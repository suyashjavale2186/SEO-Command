...
description: Detect when multiple URLs appear to compete for substantially overlapping query intent and determine whether to merge, differentiate, canonicalize, redirect, or restructure them.
---

# Cannibalization

## Purpose
Detect when multiple URLs appear to compete for substantially overlapping query intent and determine whether to merge, differentiate, canonicalize, redirect, or restructure them.

## When to trigger this skill
When two or more URLs rank for similar queries, overlap heavily in intent, or show unstable/fragmented performance.

## Step-by-step workflow
1. Group pages by query cluster and intent rather than exact keyword matching alone.
2. Compare primary purpose, audience, content depth, unique evidence, SERP intent, and observed Search Console query/page associations.
3. Classify overlap: healthy support, partial overlap, or likely competition.
4. Choose the least destructive resolution: differentiate, consolidate, redirect, canonicalize where appropriate, or restructure internal links.
5. Validate the proposed resolution against business importance and historical traffic/links.
...
Return: competing URLs; overlap evidence; classification; resolution options; selected action; rollback/validation plan; recommendation blocks.
