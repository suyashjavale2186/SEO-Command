---
name: internal-links
description: Improve internal navigation and contextual discovery by identifying links that genuinely help users and clarify relationships between pages.
---

# Internal Links

## Purpose
Improve internal navigation and contextual discovery by identifying links that genuinely help users and clarify relationships between pages.

## When to trigger this skill
When improving site architecture, supporting important pages, recovering orphan pages, or implementing a site-graph recommendation.

## Step-by-step workflow
1. Map existing internal links and identify important pages with weak contextual connections.
2. Evaluate potential source pages based on topical relevance, reader utility, and logical information flow.
3. Choose descriptive anchor text that accurately represents the destination; do not force exact-match phrasing.
4. Prefer links that improve navigation or explanation over arbitrary volume targets.
5. Validate that the proposed links do not create misleading loops, duplicate navigation, or degraded UX.
...
Return: source page; destination page; rationale; suggested anchor concept; expected user benefit; implementation notes; recommendation blocks.
