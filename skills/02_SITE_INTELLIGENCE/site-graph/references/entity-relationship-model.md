...
- ## 1. Coffee brewing [Evidence Tier: Tier 3 — Industry observation]


- grind, extract, bloom, tamp, dose, shower, degas, puck, channel, pre-infuse, pull, distribute, level, dial-in, purge, dose-and-weigh [Evidence Tier: Tier 3 — Industry observation]


- - **Generalist:** "Put the coffee in the machine and press the button. The machine will make your espresso." [Evidence Tier: Tier 3 — Industry observation]


- ## 8. Photography [Evidence Tier: Tier 3 — Industry observation]


## Elite adaptation


The retained pattern should be applied to the real user and business context: Model important entities and their relationships as explicit facts that improve content coherence and internal diagnostics. The reference is a decision aid, not a ranking formula. Start with the observed situation, classify the underlying task or risk, select an intervention that directly addresses it, and define how the result will be validated. [Evidence Tier: Tier 4 — Hypothesis]
