---
name: site-graph
description: Build a structured representation of the domain connecting topics, pages, queries, competitors, links, authors, and conversions, then use it to diagnose structural SEO opportunities.
---

# Site Graph

## Purpose
Build a structured representation of the domain connecting topics, pages, queries, competitors, links, authors, and conversions, then use it to diagnose structural SEO opportunities.

## When to trigger this skill
When analyzing an entire domain, planning topical architecture, or investigating relationships between content, queries, links, and business outcomes.

## Step-by-step workflow
1. Collect nodes and edges from available crawl, SERP, Search Console, analytics, content, author, competitor, and business data.
2. Represent relationships explicitly: topic-to-page, page-to-query, page-to-page, page-to-author, competitor-to-query, page-to-conversion, and link relationships.
3. Detect orphan pages, weak hubs, duplicated intent, missing topic coverage, authority gaps, and pages whose observed ranking positions make optimization plausible.
4. Do not treat graph centrality as a Google ranking score; it is an internal diagnostic model unless supported by evidence.
5. Prioritize graph changes using business impact, evidence confidence, and effort.
...
Return: graph schema; node/edge inventory; diagnostics; opportunities; recommendation blocks.
