...
description: Diagnose technical conditions that can prevent search engines or users from reliably accessing, understanding, and evaluating a site.
---

# Technical Seo Audit

## Purpose
Diagnose technical conditions that can prevent search engines or users from reliably accessing, understanding, and evaluating a site.

## When to trigger this skill
When auditing a domain/page, investigating traffic/indexation changes, preparing a migration, or validating an implementation.

## Step-by-step workflow
1. Establish scope and data available: live fetches, crawl output, Search Console, analytics, logs, CMS data, or supplied evidence.
2. Check crawlability: robots directives, XML sitemaps, crawlable links, blocked resources, JavaScript rendering, and orphan discovery paths.
3. Check indexation and URL handling: status codes, noindex, canonicals, duplicates, parameters, soft errors, redirect chains, and unexpected canonical choices.
4. Review information architecture, hub/spoke relationships, internal-link accessibility, and important-page discoverability.
5. Review performance and mobile experience, including Core Web Vitals evidence when available.
6. Review international signals and migration-specific risks when applicable, including hreflang, localization, redirects, and lost links.
7. Separate confirmed defects from suspected causes; pass all recommendations through evidence-engine and red-team.
...
Return: Scope/data availability; Findings by area; Severity rationale; Evidence; Recommended actions; Validation plan; recommendation blocks.
...
Do not infer indexing or crawl behavior from an HTML fetch alone when live crawler or Search Console evidence would materially change the conclusion.
