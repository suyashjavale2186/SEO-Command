...
**Purpose.** This reference gives the `search console analysis` skill a concrete operating method for **page analysis**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Evaluate page performance alongside query coverage, CTR, landing-page role, conversion outcomes, and technical/indexation status. [Evidence Tier: Tier 3 — Industry observation]
...
A page gaining impressions but losing clicks may need SERP-snippet or intent analysis rather than more content. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
