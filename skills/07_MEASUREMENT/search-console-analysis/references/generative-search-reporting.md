# Generative Search Console Reporting


**Purpose.** This reference gives the `search console analysis` skill a concrete operating method for **generative Search Console reporting**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Use the dedicated generative-AI reporting where available to observe impressions and pages shown in generative features. [Evidence Tier: Tier 3 — Industry observation]
...
Google's 2026 reporting identifies generative visibility within Search Console; do not imply access to proprietary internal AI ranking scores. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
