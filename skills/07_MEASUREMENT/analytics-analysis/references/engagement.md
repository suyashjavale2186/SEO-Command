...
A glossary page may legitimately have short sessions because the answer is immediate, while a product-comparison page may need deeper interaction; the metric must be read against task completion rather than a universal benchmark. The example is hypothetical unless the operator attaches an identifiable real source. Treat it as a pattern for reasoning, not evidence that the tactic caused a particular result. [Evidence Tier: Tier 3 — Industry observation]

## Failure signatures

['treating bounce or engagement thresholds as SEO rules', 'penalizing pages for satisfying users quickly', 'comparing unlike page types without context'] [Evidence Tier: Tier 3 — Industry observation]
