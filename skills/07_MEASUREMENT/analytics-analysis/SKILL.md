...
description: Connect organic landing-page behavior with engagement and business outcomes while being explicit about attribution limitations.
---

# Analytics Analysis

## Purpose
Connect organic landing-page behavior with engagement and business outcomes while being explicit about attribution limitations.

## When to trigger this skill
When analytics data is available and the goal is to evaluate whether SEO traffic is useful, not merely present.

## Step-by-step workflow
1. Define conversion/engagement questions and attribution window.
2. Analyze landing pages, organic source/medium, user behavior, and downstream conversions.
3. Separate observed analytics facts from interpretation and from attribution claims.
4. Identify pages with strong traffic but weak business outcomes and pages with modest traffic but high value.
5. Feed conversion evidence into opportunity and prioritization decisions.
...
Return: analysis question; observations; business implications; attribution limitations; recommendation blocks.
