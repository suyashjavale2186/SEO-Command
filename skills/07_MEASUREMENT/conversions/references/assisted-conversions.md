...
**Purpose.** This reference gives the `conversions` skill a concrete operating method for **assisted conversions**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Use assisted conversion views to understand multi-touch journeys without claiming that an assisted interaction caused the sale by itself. [Evidence Tier: Tier 4 — Hypothesis]
...
**Source basis:** New guidance for the Elite architecture; no direct legacy equivalent was available. The procedures below are deliberately specific to `assisted-conversions` and should be used as an operating aid, not as a claim about a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]
