---
name: conversions
description: Measure whether SEO work produces qualified leads, purchases, revenue, or other business outcomes defined by the conversion model.
---

# Conversions

## Purpose
Measure whether SEO work produces qualified leads, purchases, revenue, or other business outcomes defined by the conversion model.

## When to trigger this skill
When evaluating SEO initiatives, landing pages, content, or technical work against business outcomes.

## Step-by-step workflow
1. Map initiative → page/query → conversion event → value definition.
2. Review direct and assisted conversions where available.
3. Identify measurement gaps and tracking failures before making performance claims.
4. Distinguish observed revenue from inferred SEO contribution.
5. Use the evidence to recommend keep, change, scale, or stop decisions.
...
Return: conversion map; observations; attribution caveats; business-value findings; recommendation blocks.
