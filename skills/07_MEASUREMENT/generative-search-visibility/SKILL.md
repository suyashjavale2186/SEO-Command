...
description: Measure site visibility inside generative search surfaces using available first-party reporting and controlled observation, while avoiding unsupported citation guarantees.
---

# Generative Search Visibility

## Purpose
Measure site visibility inside generative search surfaces using available first-party reporting and controlled observation, while avoiding unsupported citation guarantees.

## When to trigger this skill
When tracking AI Overviews, AI Mode, generative search citations, mentions, or source selection over time.

## Step-by-step workflow
1. Define the query universe and surfaces to monitor.
2. Use Search Console generative-AI reporting when available and record rollout/data-scope limitations.
3. Supplement with reproducible observation of cited/mentioned pages where permitted and methodologically consistent.
4. Track citation frequency, mentioned pages, entities, answer coverage, and business outcomes separately.
5. Do not treat citation presence as direct causation of traffic or revenue without measurement evidence.
...
Return: monitoring method; visibility observations; page/query patterns; limitations; recommendation blocks.
