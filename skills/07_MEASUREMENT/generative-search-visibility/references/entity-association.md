...
**Purpose.** This reference gives the `generative search visibility` skill a concrete operating method for **entity association**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Check whether the site is consistently associated with the right entities, products, people, and topics across search surfaces. [Evidence Tier: Tier 3 — Industry observation]
...
The objective is clarity and corroboration, not manipulation of an assumed proprietary entity score. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
