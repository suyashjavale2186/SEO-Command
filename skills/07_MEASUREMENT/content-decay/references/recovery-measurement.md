...
**Purpose.** This reference gives the `content-decay` skill a concrete operating method for **recovery measurement**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Define the expected recovery signal before making the change and record post-change outcomes against the same baseline logic. [Evidence Tier: Tier 4 — Hypothesis]
