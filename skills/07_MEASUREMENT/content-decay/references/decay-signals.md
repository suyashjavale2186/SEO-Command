...
**Purpose.** This reference gives the `content decay` skill a concrete operating method for **decay signals**. Use it as an internal diagnostic and decision framework; it does not represent a hidden Google ranking formula. [Evidence Tier: Tier 4 — Hypothesis]


## Core principles


- Compare performance to an appropriate baseline and inspect multiple signals together. [Evidence Tier: Tier 3 — Industry observation]
...
Look for persistent changes in impressions, clicks, CTR, query mix, rankings, SERP composition, and conversion behavior. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
