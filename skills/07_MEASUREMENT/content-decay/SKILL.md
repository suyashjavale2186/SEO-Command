---
name: content-decay
description: Detect meaningful decline in page performance and distinguish refreshable decay from intent change, cannibalization, technical loss, or strategic irrelevance.
---

# Content Decay

## Purpose
Detect meaningful decline in page performance and distinguish refreshable decay from intent change, cannibalization, technical loss, or strategic irrelevance.

## When to trigger this skill
When monitoring existing content or investigating sustained declines in search visibility, clicks, conversions, or usefulness.

## Step-by-step workflow
1. Establish a page baseline using an appropriate historical comparison and business context.
2. Examine impressions, clicks, CTR, query mix, average position, conversions, freshness, SERP changes, and technical state.
3. Classify the decline: demand shift, SERP shift, competitor change, stale/incorrect content, intent mismatch, cannibalization, technical issue, or low business value.
4. Choose Refresh, Rewrite, Consolidate, Redirect, or Delete based on evidence—not on age alone.
5. Define the recovery measurement and learning record.
...
Return: baseline; decay diagnosis; recommended treatment; measurement plan; recommendation blocks.
