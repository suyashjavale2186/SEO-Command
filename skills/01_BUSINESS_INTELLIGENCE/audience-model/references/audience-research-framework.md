...
For a payroll product, compare the language used by HR managers, founders, and accountants instead of forcing all demand into one generic persona. Begin by documenting the baseline and the uncertainty around it. If the evidence is thin, the correct output may be a monitoring recommendation or a request for better data rather than a confident optimization plan. [Evidence Tier: Tier 2 — Strong empirical evidence]
