---
name: audience-model
description: Model searchers as people with needs, context, constraints, and decision stages so SEO work starts from what the user needs to accomplish.
---

# Audience Model

## Purpose
Model searchers as people with needs, context, constraints, and decision stages so SEO work starts from what the user needs to accomplish.

## When to trigger this skill
When defining a target audience, interpreting search intent, planning content, or deciding whether an opportunity fits the business audience.

## Step-by-step workflow
1. Identify audience segments from first-party evidence before relying on generic personas.
2. Map problems, desired outcomes, knowledge level, constraints, objections, and language used in real queries or customer conversations.
3. Map audience situations to query intent and decision stage.
4. Identify what evidence would satisfy the audience and what information gaps are likely to block trust.
5. Send the audience model to intent-analysis, content-brief, eeat, and conversion-model.
...
Return: audience segments; jobs-to-be-done; needs; constraints; query/intent patterns; evidence needs; unknowns; recommendation blocks.
