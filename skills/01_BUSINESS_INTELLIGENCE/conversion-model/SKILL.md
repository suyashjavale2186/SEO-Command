...
description: Map organic-search behavior to measurable business outcomes so SEO recommendations are connected to conversions, revenue, or other defined value.
---

# Conversion Model

## Purpose
Map organic-search behavior to measurable business outcomes so SEO recommendations are connected to conversions, revenue, or other defined value.

## When to trigger this skill
When SEO work affects landing pages, funnels, product/service pages, lead generation, ecommerce, or any business outcome beyond traffic.

## Step-by-step workflow
1. Define primary and secondary conversions and how they are measured.
2. Map organic landing pages to user intent and funnel stage.
3. Identify assisted-conversion paths and attribution limits.
4. Flag pages where ranking/traffic is not a sufficient success metric.
5. Feed conversion potential into opportunity-scoring and prioritization.
...
Return: conversion taxonomy; funnel map; page-to-conversion mapping; measurement gaps; recommendation blocks.
