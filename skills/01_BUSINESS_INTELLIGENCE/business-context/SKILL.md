...
description: Create the operating context that makes SEO recommendations useful to the business rather than optimized only for rankings or traffic.
---
...
2. Identify which outcomes matter: qualified traffic, leads, purchases, retention, assisted revenue, brand discovery, or another defined business result.
3. Record data provenance and owner for each business fact. Mark unknowns explicitly.
4. Map SEO opportunities to the business outcomes they can plausibly influence.
5. Send the context to audience-model, conversion-model, opportunity-scoring, and prioritization.
...
Return: Business context; verified facts; assumptions; unknowns; business goals; constraints; SEO implications; recommendation blocks.
