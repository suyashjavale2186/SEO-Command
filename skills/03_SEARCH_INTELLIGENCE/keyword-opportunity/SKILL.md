...
description: Replace raw search-volume prioritization with a multi-factor opportunity assessment that incorporates business value, demand, intent, feasibility, information advantage, authority fit, conversion potential, and resource cost.
---

# Keyword Opportunity

## Purpose
Replace raw search-volume prioritization with a multi-factor opportunity assessment that incorporates business value, demand, intent, feasibility, information advantage, authority fit, conversion potential, and resource cost.

## When to trigger this skill
When evaluating keyword/topic candidates, building a content backlog, or choosing what to pursue next.

## Step-by-step workflow
1. Define the business outcome and audience first.
2. Gather demand evidence from available keyword tools, Search Console, SERP observations, customer language, and existing site performance.
3. Assess intent fit, ranking feasibility, information advantage, authority fit, conversion potential, and resource cost.
4. Score the opportunity using the required model without pretending the inputs are more precise than the evidence supports.
5. If no real keyword database is available, explicitly state that the analysis is based on observed queries/SERPs rather than proprietary volume or difficulty data.
6. Pass leading opportunities to prioritization and roadmap.
...
Return: candidate table; input evidence; Opportunity Score explanation; data limitations; recommended opportunities with blocks.
