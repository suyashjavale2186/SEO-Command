...
- # Query Format Matching — Expanded [Evidence Tier: Tier 3 — Industry observation]


- Google picks a snippet format based on query shape. Write the answer in the wrong format and another page will win, even if your content is better. This is the full pattern list. [Evidence Tier: Tier 3 — Industry observation]


- ## The Expanded Table [Evidence Tier: Tier 3 — Industry observation]


- | "What is X" | Paragraph, [fixed length rule removed; use the observed SERP format and clarity objective] | "what is affiliate marketing" | Most common snippet type. Answer sits directly under an H2 that mirrors the query. | [Evidence Tier: Tier 3 — Industry observation]


- | "What does X mean" | Paragraph, a concise length suited to the SERP format | "what does SEO mean" | Shorter than "what is X" — Google wants a dictionary-style gloss, not an explainer. | [Evidence Tier: Tier 3 — Industry observation]


- | "What are X" | Paragraph or unordered list | "what are backlinks" | Splits on subject: single definition → paragraph; plural enumerable → list. | [Evidence Tier: Tier 3 — Industry observation]


- | "How to X" | Ordered list sized to the procedure observed in the current SERP | "how to bake sourdough" | The canonical list-snippet query. Steps must use `<ol>` with `<li>`. | [Evidence Tier: Tier 3 — Industry observation]


- | "How do I X" | Ordered list sized to the procedure observed in the current SERP | "how do I reset my router" | First-person variant, same format. | [Evidence Tier: Tier 3 — Industry observation]


- | "How do you X" | Ordered list sized to the procedure observed in the current SERP | "how do you make cold brew" | Second-person variant. Same rules. | [Evidence Tier: Tier 3 — Industry observation]


- ## Ambiguous and Edge Cases [Evidence Tier: Tier 3 — Industry observation]


## Elite adaptation


The retained pattern should be applied to the real user and business context: Match content structure to the observed task and result format while retaining complete page usefulness. The reference is a decision aid, not a ranking formula. Start with the observed situation, classify the underlying task or risk, select an intervention that directly addresses it, and define how the result will be validated. [Evidence Tier: Tier 4 — Hypothesis]
