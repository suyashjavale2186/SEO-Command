...
description: Infer the job the searcher is trying to accomplish and the decision stage represented by a query/SERP, then test that interpretation against actual results.
---

# Intent Analysis

## Purpose
Infer the job the searcher is trying to accomplish and the decision stage represented by a query/SERP, then test that interpretation against actual results.

## When to trigger this skill
When choosing content type, separating overlapping queries, or deciding whether a page matches the searcher’s need.

## Step-by-step workflow
1. Start with the query language and business context.
2. Classify likely intent and sub-intent, including problem-solving, comparison, evaluation, purchase, navigation, or local needs as applicable.
3. Use the current SERP as evidence, especially result formats and recurring page purposes.
4. Record ambiguity and competing interpretations instead of forcing a single label when evidence is mixed.
5. Use the result to choose content format, information depth, and conversion path.
...
Return: intent classification; supporting SERP evidence; audience job; stage; ambiguity; content implications; recommendation blocks.
