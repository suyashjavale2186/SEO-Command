...
description: Assess visibility and citation opportunities in generative search experiences while explicitly rejecting the idea that secret optimization tricks exist beyond strong foundational SEO.
---

# Generative Search

## Purpose
Assess visibility and citation opportunities in generative search experiences while explicitly rejecting the idea that secret optimization tricks exist beyond strong foundational SEO.

## When to trigger this skill
When the user asks about AI Overviews, AI Mode, generative search, citations, mentions, or entity visibility.

## Step-by-step workflow
1. Define the generative-search surface and query set being studied.
2. Record observed citations, mentions, source selection, entity associations, answer coverage, and brand inclusion where measurement is possible.
3. Check whether the site is crawlable and useful enough for ordinary search before proposing generative-search-specific work.
4. Treat any claimed special trick as a hypothesis unless supported by official documentation or strong reproducible evidence.
5. Use Search Console generative-AI reporting where available; state rollout/availability limitations when relevant.
6. Recommend changes that strengthen underlying usefulness, evidence, clarity, entities, authority, and technical accessibility.
...
Return: surface/query scope; visibility observations; cited/mentioned pages; missing answer coverage; evidence limits; recommendation blocks.
...
Do not imply secret technical requirements for AI Overviews or AI Mode.
