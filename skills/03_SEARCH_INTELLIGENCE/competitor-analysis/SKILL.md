...
description: Select comparable competitors and analyze what they offer, what evidence they have, and where they leave useful gaps, without assuming competitors are interchangeable.
---

# Competitor Analysis

## Purpose
Select comparable competitors and analyze what they offer, what evidence they have, and where they leave useful gaps, without assuming competitors are interchangeable.

## When to trigger this skill
When building a content brief, assessing ranking feasibility, finding information gaps, or evaluating authority/context.

## Step-by-step workflow
1. Define the competitor comparison frame: same intent, audience, product context, geography, or business model.
2. Exclude visually similar but strategically incomparable results.
3. Compare content purpose, unique evidence, depth where relevant, technical accessibility, author context, and user value.
4. Separate observed competitor properties from claims about why Google ranked them.
5. Identify differentiated opportunities rather than copying their structure verbatim.
...
Return: comparable competitor set; comparability rationale; strengths; weaknesses; gaps; opportunities; recommendation blocks.
