...
description: Translate verified technical findings into implementation-ready fixes with dependencies, acceptance criteria, and rollback/validation checks.
---

# Technical Fixes

## Purpose
Translate verified technical findings into implementation-ready fixes with dependencies, acceptance criteria, and rollback/validation checks.

## When to trigger this skill
When technical-seo-audit or indexation work produces approved implementation tasks.

## Step-by-step workflow
1. Convert each verified issue into a concrete change specification.
2. Define affected URLs/components, intended behavior, owner/skill, dependencies, acceptance criteria, and risk.
3. Specify pre-change evidence and post-change validation, including Search Console or crawl checks where applicable.
4. Flag fixes that require engineering review or cannot be safely simulated by the agent.
5. Pass the final action list through risk-detection.
...
Return: implementation ticket list; evidence; dependencies; acceptance criteria; validation; rollback considerations; recommendation blocks.
