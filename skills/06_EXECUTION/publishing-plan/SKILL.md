...
description: Sequence SEO work by dependencies, evidence readiness, business priority, and operational capacity so the site receives the highest-value changes first.
---

# Publishing Plan

## Purpose
Sequence SEO work by dependencies, evidence readiness, business priority, and operational capacity so the site receives the highest-value changes first.

## When to trigger this skill
When multiple content, technical, authority, or measurement tasks are ready for execution.

## Step-by-step workflow
1. Inventory approved initiatives and their evidence status.
2. Map dependencies and blockers.
3. Estimate effort qualitatively and identify reversible versus high-risk changes.
4. Sequence work through prioritization rather than calendar volume targets.
5. Attach acceptance criteria and measurement windows to each major launch.
6. Keep the plan dynamic as new evidence arrives.
...
Return: initiative sequence; dependencies; owners; readiness; validation; recommendation blocks.
