...
**Purpose.** This reference is the operating memory for `publishing-plan` when the exact job is to **sequence content publication around readiness, QA, measurement, and dependency release**. Use it to decide what evidence to gather, how to act on the named artifact, and what would invalidate the conclusion. It is not a claim about an undisclosed ranking formula and it does not guarantee an outcome. [Evidence Tier: Tier 3 — Industry observation]

## Use conditions

The unit of work is **launch checklist**, not “SEO” in general. Before opening a checklist, name the URL, dataset, query group, experiment, stakeholder decision, or outreach asset under review. Record the state that exists now and the state the business or user actually needs. The distinction matters: a technically clean implementation can still be the wrong action if it serves the wrong audience, market, or commercial objective. [Evidence Tier: Tier 3 — Industry observation]

## Investigation route

- confirm approved claims and assets [Evidence Tier: Tier 3 — Industry observation]
- verify canonical/internal-link placement [Evidence Tier: Tier 1 — Officially documented]
- load measurement annotations [Evidence Tier: Tier 3 — Industry observation]
- check production rendering and indexability [Evidence Tier: Tier 3 — Industry observation]
- record launch owner and rollback path [Evidence Tier: Tier 3 — Industry observation]
...
A regulated-finance guide cannot publish until legal review and source timestamps are complete; the launch checklist makes those gates visible instead of treating publishing as a single button press. The example is hypothetical unless the operator attaches an identifiable real source. Treat it as a pattern for reasoning, not evidence that the tactic caused a particular result. [Evidence Tier: Tier 3 — Industry observation]

## Invalid patterns

['publishing before source review', 'no post-launch validation', 'treating the CMS publish timestamp as the end of the job'] [Evidence Tier: Tier 3 — Industry observation]
