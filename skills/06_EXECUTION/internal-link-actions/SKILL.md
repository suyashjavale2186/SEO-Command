---
name: internal-link-actions
description: Convert internal-link analysis into specific, user-useful implementation actions that strengthen navigation and topical relationships.
---

# Internal Link Actions

## Purpose
Convert internal-link analysis into specific, user-useful implementation actions that strengthen navigation and topical relationships.

## When to trigger this skill
When internal-links or site-graph identifies orphan pages, weak hubs, or useful contextual connections.

## Step-by-step workflow
1. List source and destination pages and verify each destination’s current purpose.
2. Write a contextual anchor concept and sentence placement based on reader utility.
3. Avoid arbitrary volume quotas or exact-match anchor forcing.
4. Check for conflicting destination intent or duplicate links in the same context.
5. Validate after implementation through crawl/HTML checks and user path review.
...
Return: prioritized link actions; source/destination; rationale; anchor concept; validation; recommendation blocks.
