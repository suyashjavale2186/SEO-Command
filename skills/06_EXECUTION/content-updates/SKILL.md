...
description: Turn content-diagnostics into an explicit decision among refresh, rewrite, consolidate, redirect, or delete, with evidence and measurement.
---

# Content Updates

## Purpose
Turn content-diagnostics into an explicit decision among refresh, rewrite, consolidate, redirect, or delete, with evidence and measurement.

## When to trigger this skill
When improving or pruning existing pages based on decay, cannibalization, intent mismatch, or content-quality evidence.

## Step-by-step workflow
1. Collect baseline performance, query/page relationships, links, business value, and current SERP context.
2. Classify the page’s condition and its retained value.
3. Select the least destructive action that solves the observed issue.
4. Define exactly what evidence should be preserved, added, removed, merged, or redirected.
5. Specify post-change validation and learning capture.
...
Return: decision; rationale; change specification; dependencies; validation plan; recommendation blocks.
