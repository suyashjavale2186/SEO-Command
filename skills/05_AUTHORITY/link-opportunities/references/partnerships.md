...
**Source basis:** Ported and filtered from: skills/linkbuilding/references/tactics/strategic-partnerships.md. The legacy structure is retained where it is operationally useful; unsupported Google-mechanism claims and arbitrary SEO targets are not carried forward. [Evidence Tier: Tier 3 — Industry observation]


## Ported operating assets


- # Tactic 14: Strategic Partnerships & Co-Marketing [Evidence Tier: Tier 3 — Industry observation]


- ## What It Is [Evidence Tier: Tier 3 — Industry observation]


- Building genuine business relationships with complementary (non-competing) businesses and leveraging those partnerships for mutual link building. This includes co-authored content, joint webinars, integration partnerships, cross-promotions, podcast collaborations, and co-branded research. Each partner benefits from the other's audience and link equity. [Evidence Tier: Tier 3 — Industry observation]


- ## Why It Works [Evidence Tier: Tier 3 — Industry observation]


- Links arising from genuine partnerships can be legitimate because the relationship itself explains why the link exists, and the partnership may also provide distribution to a relevant audience. Do not assume Google assigns special value simply because a link comes from a partner; evaluate topical relevance, editorial context, and user value. [Evidence Tier: Tier 3 — Industry observation]


- ## Step-by-Step Process [Evidence Tier: Tier 3 — Industry observation]


- ### Step 1: Identify Complementary Partners (2-3 hours) [Evidence Tier: Tier 3 — Industry observation]


- - **Complementary tools**: If you sell email marketing, partner with CRM companies [Evidence Tier: Tier 3 — Industry observation]


- - **Adjacent audiences**: Same buyers, different products/services [Evidence Tier: Tier 3 — Industry observation]


- - **Similar stage**: Companies at a similar growth phase are more willing to collaborate [Evidence Tier: Tier 3 — Industry observation]


- - Use competitor data to identify companies in adjacent spaces (not direct competitors) [Evidence Tier: Tier 3 — Industry observation]


- ### Step 2: Propose Collaboration (1 hour per partner) [Evidence Tier: Tier 3 — Industry observation]


- 1. **Joint research/survey** — Both parties promote, both earn links [Evidence Tier: Tier 3 — Industry observation]


- ### Step 3: Execute and Cross-Promote [Evidence Tier: Tier 3 — Industry observation]


- - Both partners promote through their channels [Evidence Tier: Tier 3 — Industry observation]
...
The retained pattern should be applied to the real user and business context: Use the reference to help the link opportunities skill make defensible decisions about partnerships. The reference is a decision aid, not a ranking formula. Start with the observed situation, classify the underlying task or risk, select an intervention that directly addresses it, and define how the result will be validated. [Evidence Tier: Tier 4 — Hypothesis]
...
Suppose When evaluating partnerships, establish the intended outcome, gather direct evidence, compare plausible explanations, and choose a measurable intervention. Begin by proving the symptom exists and identifying the page/query/business role involved. If the evidence points to a content problem, add useful information or fix the intent mismatch; if it points to technical access or indexation, fix the underlying technical state first. Do not use a content rewrite to treat a problem whose evidence points elsewhere. [Evidence Tier: Tier 2 — Strong empirical evidence]
