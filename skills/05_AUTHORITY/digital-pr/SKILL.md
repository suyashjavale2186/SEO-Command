---
name: digital-pr
description: Design newsworthy, useful, evidence-backed outreach and digital-PR concepts that can earn attention and references without relying on manipulative link placement.
---

# Digital Pr

## Purpose
Design newsworthy, useful, evidence-backed outreach and digital-PR concepts that can earn attention and references without relying on manipulative link placement.

## When to trigger this skill
When seeking earned coverage, expert visibility, original research exposure, or authority-building opportunities.

## Step-by-step workflow
1. Identify a story, dataset, expert viewpoint, original research, or useful resource that is genuinely newsworthy or valuable to a defined audience.
2. Validate the evidence and the reason a journalist/editor/community would care.
3. Define appropriate outreach targets based on topical and audience fit.
4. Design a pitch around the asset, not around a demand for a link.
5. Record potential legal, reputational, disclosure, and accuracy risks.
6. Treat earned links/mentions as possible outcomes, not guarantees.
...
Return: PR angle; asset; proof; audience/outlet fit; outreach concept; risks; measurement; recommendation blocks.
