...
**Source basis:** Ported and filtered from: skills/linkbuilding/references/tactics/competitor-backlink-gap.md. The legacy structure is retained where it is operationally useful; unsupported Google-mechanism claims and arbitrary SEO targets are not carried forward. [Evidence Tier: Tier 3 — Industry observation]
...
- Using tools to identify websites that link to your competitors but not to you, then systematically pursuing those same link opportunities. This is "reverse engineering" your competitors' link profiles to find proven, achievable link sources. [Evidence Tier: Tier 3 — Industry observation]
...
- 3. Include a small set of aspirational competitors and a small set of realistic peers selected for query, audience, market, page type, and authority comparability rather than a fixed third-party score. [Evidence Tier: Tier 3 — Industry observation]


- ### Step 2: Run Backlink Gap Analysis [Evidence Tier: Tier 3 — Industry observation]


- 1. Use backlink gap data with your domain vs top 3 competitors [Evidence Tier: Tier 3 — Industry observation]


- ### Step 3: Categorize Opportunities (2 hours) [Evidence Tier: Tier 3 — Industry observation]


## Elite adaptation


The retained pattern should be applied to the real user and business context: Use the reference to help the authority analysis skill make defensible decisions about backlink evaluation. The reference is a decision aid, not a ranking formula. Start with the observed situation, classify the underlying task or risk, select an intervention that directly addresses it, and define how the result will be validated. [Evidence Tier: Tier 4 — Hypothesis]
...
Suppose When evaluating backlink evaluation, establish the intended outcome, gather direct evidence, compare plausible explanations, and choose a measurable intervention. Begin by proving the symptom exists and identifying the page/query/business role involved. If the evidence points to a content problem, add useful information or fix the intent mismatch; if it points to technical access or indexation, fix the underlying technical state first. Do not use a content rewrite to treat a problem whose evidence points elsewhere. [Evidence Tier: Tier 2 — Strong empirical evidence]
