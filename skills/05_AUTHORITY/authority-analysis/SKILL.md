...
description: Evaluate the quality and relevance of evidence about site/page authority without reducing authority to a single third-party metric.
---

# Authority Analysis

## Purpose
Evaluate the quality and relevance of evidence about site/page authority without reducing authority to a single third-party metric.

## When to trigger this skill
When comparing competitors, assessing link profiles, validating authority gaps, or deciding whether link acquisition is justified.

## Step-by-step workflow
1. Collect backlink/referring-domain evidence from available tools.
2. Assess relevance, editorial context, quality, durability, and suspicious patterns.
3. Treat third-party metrics such as DR/DA as comparative vendor metrics, not Google ranking scores.
4. Assess non-link authority evidence: expertise, citations, industry recognition, original data, and useful reputation where verifiable.
5. Recommend acquisition only where authority evidence identifies a meaningful gap that complements content/site quality.
...
Return: authority evidence; link-quality assessment; non-link authority evidence; gaps; recommended actions; recommendation blocks.
