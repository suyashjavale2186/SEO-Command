...
*No exports. No API keys. No paste-in data. Production-tested at [Bizwit AI](https://bizwitai.com).*
...
```bash
/plugin marketplace add bizwitai/superseo-skills
...
```bash
git clone https://github.com/bizwitai/superseo-skills.git
...
The skills in this repo handle anything an agent can research live — audits, briefs, writing, E-E-A-T, clusters, snippets, standalone link tactics. What they can't do is run against historical Search Console data or monitor a site over time. That's where [Bizwit AI](https://bizwitai.com) picks up.
...
Free 14-day trial at **[bizwitai.com](https://bizwitai.com)**.
...
If you build something interesting on top of these skills, we'd love to hear about it — drop a note at [hello@bizwitai.com](mailto:hello@bizwitai.com).
...
**Built by [Bizwit AI](https://bizwitai.com).**
